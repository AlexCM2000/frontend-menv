<template>
  <div class="mt-6 space-y-5">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div>
        <h2 class="text-2xl font-extrabold text-[#3A3A3A]">Mi Calendario de Citas</h2>
        <p class="text-gray-500 text-sm mt-1">Visualiza tus citas programadas</p>
      </div>
...
const calendarOptions = {
  ...
  views: {
    listWeek: {
      noEventsText: 'No tienes citas esta semana',
    },
  },
}
</script>
