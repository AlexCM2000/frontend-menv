      ...
      <div class="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
        ...
        <nav class="flex items-center gap-1 flex-1 flex-wrap">
          <RouterLink
            ...
            class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium text-gray-600 hover:bg-blue-50 hover:text-blue-700 transition-colors"
          ...
          <RouterLink
            ...
            class="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-blue-600 text-white hover:bg-blue-700 transition-colors"
          >
        ...
        <div class="flex items-center gap-2 shrink-0">
          <span
            class="text-sm text-gray-600 hidden md:inline truncate max-w-[140px]"
          >
            {{ getUserName }}
          </span>
          <RouterLink
            ...
            class="flex items-center justify-center w-8 h-8 rounded-lg text-gray-500 hover:bg-blue-50 hover:text-blue-600 transition-colors"
          >
            <i class="pi pi-user-edit text-sm"></i>
          </RouterLink>
          <button
            class="flex items-center gap-1.5 bg-red-50 hover:bg-red-100 text-red-600 px-3 py-1.5 rounded-lg text-xs font-semibold transition-colors"
            @click="logout"
          >
